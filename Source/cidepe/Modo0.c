...
bool EstadoModo0(int16 _flagEstado) {
    ...
    case STATE_SAVE_USB:   //Salvamento na pendrive
        Salvar_usb();
        //Aqui analisa a tecla e decide se salva na Usb ou se segue para a fun�a�
        bret=false;
    ...
    case STATE_WAIT_PEN_DRIVE:   //Salvamento na pendrive
        if(!GetPendriveState()){
            ...
            //For�a a tecla para salvamento no pendrive, se n�o estiver inserida iria pedir pendrive e confirma��o pela tecla
 ...
 * \details     quando chegou aqui finalizou o ensaio e analisa o que deve mostrar na tela
                em fun��o da escolha do usu�rio 
 ...
 *               agora quando chamado j� calcula os resultados (antes sempre recalculava no estado da fun��o)
 *               
 *               
 *               
 * \author     
...
bool EstadoModo2(int16 _flagEstado) {
    ...
    case 750:
        tela750();   //fun��o 7 mostra temo s0
        lcd_posicaoxy(3, LCD_LINHA_1);
