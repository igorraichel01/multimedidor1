...
/*********************************************************************************************//**
 * \fn         LCD_DelayUs
 * \details    Fun��o de delay para o LCD
 ...
 * @ingroup nome
 *
 * @brief  descri��o breve
 *
 *
 * @param[n]   descri��o do par�metro n
 *
 ...
 *
 *    P�e todos os caracteres de pcDisplay na tela at� tamanho ucSize
 *
 *
 * @param[usPos]   posi��o inicial
 * @param[usLine]   linha
 ...
 *
 *    P�e todos os caracteres de pcDisplay na tela at� encontrar um '\0' (fim de string)
 *
 *
 * @param[usPos]   posi��o inicial
 * @param[usLine]   linha
 ...
 * @ingroup lcd
 *
 * @brief  escreve uma string a partir das posi��es usPos e usLine com word break e retorna o ponto de parada do LCD
 *
 *
 *
 * @param[usPos]   posi��o inicial
 * @param[usLine]   linha virtual de in�cio
 ...
 * @ingroup lcd
 *
 * @brief  limpa todos os espa�os CGRAM
 *
 *    Limpa todos os espa�os CGRAM. Utilizado quando for escrita uma tela do zero.
 *
 *
 *
 * @return  None
 ...
 * @ingroup lcd
 *
 * @brief  limpa os espa�os n�o usados da CGRAM
 *
 *    Limpa os espa�os n�o usados da CGRAM. Utilizado apenas quando for atualizar os valores da tela. (lcdPutMaskedScreen)
 *
 *
 *
 * @return  None
 ...
 * @brief  limpa a tela
 *
 *    limpa o lcd ( Aten��o: extremamente lento (~1.5ms) )
 *
 *
 *
 * @return  None
...
void LCD_HoldWhileBusy(void) {
     ...
     * No pior dos casos o LCD n�o mostra algum caracter, melhor do que travar. */
    timeout = 0;
}
 ...
 *
 * @param[usPos]  posi��o X inicial no LCD
 ...
 * @ingroup lcd
 *
 * @brief  opera caractere de entrada e retorna a transforma��o para c�digo CGRAm se necess�rio
 *
 * @param[input]  caractere a ser operado
 *
 * @return  caractere transformado em endere�o reconhecido pela CGRAm
 *
 *****************************************************************************/
char LCD_OperateChar(char input) {
    ...
    *lcdVirtualCursor++ = input;
    if (!( /* eliminar caracteres mais usados da verifica��o para performance! */
 ...
 * @ingroup lcd
 *
 * @brief  Calcula a posi��o absoluta do cursor dada sua posi��o na DDRAM
 *
 *
 * @param[value]  Posi��o na DDRAM
 *
 ...
 * @ingroup lcd
 *
 * @brief  escreve os registradores para mostrar um cursor na posi��o desejada
 *
 *    escreve os registradores para mostrar um cursor na posi��o desejada
 *
 *
 * @param[usRelPos]  posi��o relativa ( para a esquerda ) para mover o cursors
 *
 *****************************************************************************/
